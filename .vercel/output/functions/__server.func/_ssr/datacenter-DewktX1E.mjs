...
import { Activity, ArrowRight, Camera, Clock, Cpu, Headset, Layers, Mail, MapPin, MessageCircle, Network, PhoneCall, Plug, Server, ShieldCheck, Sparkles, Wind, Wrench } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/datacenter-DewktX1E.js
...
var capabilities = [
	{
		...
		description: "Standard and custom server racks, hot/cold aisle containment, PDUs and cable management engineered for enterprise density."
	},
	{
		icon: Network,
		title: "Structured Cabling",
		description: "Cat6, Cat6A and OM4 fibre backbones designed to TIA-942 standards with full certification and labelling."
	},
	{
		icon: Plug,
		title: "Power Distribution & UPS",
		description: "Redundant power paths, rack PDUs, UPS sizing, battery backup and generator integration planning."
	},
	{
		icon: Wind,
		title: "Cooling & Environmental Control",
		description: "Precision CRAC units, in-row cooling, hot-aisle containment and temperature/humidity monitoring."
	},
	{
		icon: Camera,
		title: "Physical Security & Access",
		description: "Biometric access control, CCTV integration, environmental sensors and centralised command room oversight."
	},
	{
		icon: ShieldCheck,
		title: "Monitoring & DCIM",
		description: "Real-time monitoring of power, cooling, humidity and access events with alerting and reporting dashboards."
	}
];
var phases = [
	{
...
var dcPartners = partners.filter((p) => [
	"Hewlett Packard Enterprise",
	"Dell Technologies",
	"Cisco Systems"
].includes(p.name));
var dcTextVendors = ["APC by Schneider", "Vertiv"];
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											children: "Designed, Built & Operated"
										})
									]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mx-auto max-w-xl text-base text-hero-muted sm:text-lg lg:mx-0 lg:text-xl",
									children: "Racks, containment, structured cabling, power, cooling and DCIM — engineered to TIA-942 standards and supported 24/7 across Pakistan."
								}),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
											to: "/contact",
											hash: "request",
											children: ["Book Site Survey", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-gradient",
								children: "Data Centre Stack"
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 text-sm text-muted-foreground sm:text-base",
						children: "From racks to redundancy — every layer engineered for reliability, efficiency and scale."
					})
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-gradient",
									children: "That Performs"
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-3 text-sm text-muted-foreground sm:text-base",
							children: "Standards-aligned design, vendor-neutral engineering, and SLA-backed operations."
						})
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-8 grid gap-5 sm:mt-10 sm:grid-cols-2 lg:grid-cols-4",
					children: valueHighlights.map((item, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
						initial: {
							opacity: 0,
							y: 14
						},
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 text-sm text-muted-foreground sm:text-base",
						children: "A disciplined build methodology with full documentation at every stage."
					})
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-8 grid gap-5 sm:mt-10 sm:grid-cols-2 lg:grid-cols-4",
				children: phases.map((item, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
					initial: {
						opacity: 0,
						y: 14
					},
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-3 text-sm text-muted-foreground sm:text-base",
								children: "Contractual response and resolution times for your data centre infrastructure."
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-gradient",
								children: "Data Centre Vendors"
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 text-sm text-muted-foreground sm:text-base",
						children: "Multi-vendor expertise across compute, networking, power and cooling platforms."
					})
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-8 grid grid-cols-2 gap-4 sm:mt-10 sm:grid-cols-3 lg:grid-cols-5",
				children: [dcPartners.map((partner) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				}, partner.name)), dcTextVendors.map((name) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex flex-col items-center justify-center gap-2 rounded-xl border border-border bg-card p-4 text-center shadow-sm transition-all hover:border-primary/30 hover:shadow-md",
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-3 text-sm text-muted-foreground sm:text-base",
							children: "Common questions about data centre design, build and operations."
						})
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-8 space-y-3",
					children: datacenterFaqs.map((faq, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.details, {
						initial: {
							opacity: 0,
							y: 10
						},
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-3 text-sm text-muted-foreground sm:text-base",
							children: "Pair your data centre with complementary compute, storage and networking solutions."
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							...
							children: "Ready to Build Your Data Centre?"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-3 text-sm text-hero-muted sm:text-base",
							children: "Book a site survey with our certified engineers — and get a full design proposal with SLA-backed support."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
//#endregion
export { DataCentrePage as component };
