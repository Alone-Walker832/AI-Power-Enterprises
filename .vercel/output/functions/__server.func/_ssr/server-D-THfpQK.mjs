import "../_runtime.mjs";
import { H3Event, toResponse } from "../_libs/h3-v2+rou3+srvx.mjs";
...
import { RouterProvider, defineHandlerCallback, executeRewriteInput, getScriptPreloadAttrs, getStylesheetHref, invariant, isNotFound, isRedirect, isResolvedRedirect, isSsrResponse, normalizeSsrResponse, renderRouterToStream, replaceSsrResponse, resolveManifestAssetLink, resolveManifestCssLink, rootRouteId, stripSsrResponseBody } from "../_libs/@tanstack/react-router+[...].mjs";
import { createMemoryHistory } from "../_libs/tanstack__history.mjs";
import { attachRouterServerSsrUtils, createRawStreamRPCPlugin, createSerializationAdapter, defaultSerovalPlugins, fromJSON, getNormalizedURL, getOrigin, makeSerovalPlugin, mergeHeaders, toCrossJSONAsync, toCrossJSONStream } from "../_libs/@tanstack/router-core+[...].mjs";
import { createCsrfMiddleware } from "./createCsrfMiddleware-xuZnLSS7.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-_LBo3f0x.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BjflIjQU.mjs"),
		import("./start-DDdqLQMM.mjs"),
