...
import { require_jsx_runtime } from "../@radix-ui/react-collection+[...].mjs";
...
//#endregion
export { GLOBAL_TSR, HeadContent, Link, Outlet, RouterProvider, Scripts, TSR_SCRIPT_BARRIER_ID, createFileRoute, createInlineCssPlaceholderAsset, createInlineCssStyleAsset, createLRUCache, createRootRouteWithContext, createRouter, decodePath, defineHandlerCallback, executeRewriteInput, getScriptPreloadAttrs, getStylesheetHref, invariant, isNotFound, isRedirect, isResolvedRedirect, isSsrResponse, lazyRouteComponent, normalizeSsrResponse, renderRouterToStream, replaceSsrResponse, resolveManifestAssetLink, resolveManifestCssLink, rootRouteId, stripSsrResponseBody, useLocation, useRouter, useRouterState };
