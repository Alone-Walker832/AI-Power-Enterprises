...
import { createContextScope, createSlot, require_jsx_runtime, useComposedRefs } from "./react-collection+[...].mjs";
...
//#endregion
export { Dialog, DialogClose, DialogContent, DialogDescription, DialogOverlay, DialogPortal, DialogTitle, DialogTrigger, DismissableLayer, FocusScope, Portal, Presence, Primitive, ReactRemoveScroll, hideOthers, useCallbackRef$1 as useCallbackRef, useControllableState, useFocusGuards, useId, useLayoutEffect2 };
