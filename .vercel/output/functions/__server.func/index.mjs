...
import { H3Core, HTTPError, composeMiddleware, createMatcherFromFind, defineLazyEventHandler, headers, memoizeRouteRulesMatcher } from "./_libs/h3+rou3+srvx.mjs";
import { NodeResponse } from "./_libs/srvx.mjs";
...
var _lazy_1fa5d01c473ac2e9 = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_1fa5d01c473ac2e9
	};
	return ((_m, p) => {
		return {
			data,
